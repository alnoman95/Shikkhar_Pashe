...
class DonateController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.pages.donate.index',compact('donate'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $donate->ex_date=$request->ex_date;
        $donate->cvv=$request->cvv;
        $donate->zip=$request->zip;
        $donate->taka=$request->taka;
        $donate->save();
        Toastr::success('Successfully Donated!','Info');
