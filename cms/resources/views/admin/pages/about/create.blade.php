            ...
            <div class="col-lg-12">
                ...
                <div class="element-wrapper">
                    <h6 class="element-header">
                        Add New About
                        <a class="btn btn-success btn-sm float-right mr-2" href="{{route('about.index')}}">View All</a>
                    </h6>
                    <div class="element-box">
                        ...
                        @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <textarea class="form-control" rows="4" name="sub_heading" placeholder="Enter Sub Heading"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
