                    ...
                    <div class="element-box">
                        ...
                        @method('PUT')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input class="form-control" value="{{$events->title}}" type="text" name="title">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label offset-md-1">Sub Title</label>
                                <div class="col-sm-7">
                                    <textarea class="form-control" rows="4" name="sub_title">{{$events->sub_title}}</textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label offset-md-1">Address</label>
                                <div class="col-sm-7">
                                    <input type="text" name="location" class="form-control" value="{{$events->location}}"> 
                                </div>
                            </div>                            
                            <div class="form-group row">
