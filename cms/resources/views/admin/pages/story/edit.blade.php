            ...
            <div class="col-lg-12">
                <div class="element-wrapper">
                    <h6 class="element-header">
                        Edit Story
                        <a class="btn btn-success btn-sm float-right mr-2" href="{{route('story.index')}}">View All</a>
                    </h6>
                    <div class="element-box">
                        ...
                        @method('PUT')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input class="form-control" value="{{$story->title}}" type="text" name="title">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-sm-2 offset-md-1" for="">Writer Name</label>
                                <div class="col-sm-7">
                                    <input class="form-control" value="{{$story->name}}" type="text" name="name">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label offset-md-1">Sub Title</label>
                                <div class="col-sm-7">
                                    <textarea class="form-control" rows="4" name="sub_title">{{$story->sub_title}}</textarea>
                                </div>
                            </div>
                            <div class="form-group row">
